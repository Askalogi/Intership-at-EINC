...
from class_dataset_patches import CustomSinPatchesDataset
...
dataset =  CustomSinPatchesDataset(root="../custom_dataset_patches", transform=transform)
...
class LI2Model(nn.Module):
    ...
    def forward(self, x):
        ...
        x_encoded = constant_current_lif_encode(
            x * 10, p=norse.LIFParameters(v_reset=-1000), seq_length=self.num_steps
        )
